...
export default function CatalogoPage() {
    ...
    const filteredBulls = allBulls.filter((bull: any) => {
        ...
        const matchesRace = selectedRace === 'todas' || bull.raca === selectedRace;
        const matchesCategory = selectedCategory === 'todas' || bull.categoria === selectedCategory;

        return matchesSearch && matchesRace && matchesCategory;
    });
    return (
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                            Catálogo <span className="text-red-800">Completo</span>
                        </h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Navegue por nossa seleção completa de touros com genética superior.
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="pl-9 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent appearance-none bg-white"
                                        >
